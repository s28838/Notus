      ...
      <section style={{ padding: '1rem' }}>
        <div className="glass-card" style={{ padding: '1.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            <div>
              <h3 style={{ margin: '0 0 0.25rem', fontSize: '1.125rem', fontWeight: 700 }}>Aktywność Studentów</h3>
              <p style={{ margin: 0, fontSize: '0.875rem', color: 'var(--text-secondary)' }}>Obecność na przestrzeni tygodnia</p>
            </div>
            <div style={{ display: 'flex', gap: '0.25rem', background: 'var(--border-light)', padding: '0.25rem', borderRadius: '0.5rem' }}>
              <button style={{ padding: '0.25rem 0.75rem', fontSize: '0.75rem', fontWeight: 700, background: 'white', borderRadius: '0.375rem', border: 'none', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>Tydz</button>
              <button style={{ padding: '0.25rem 0.75rem', fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-secondary)', background: 'transparent', border: 'none' }}>Msc</button>
            </div>
          </div>
          
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '0.75rem', height: '10rem', alignItems: 'flex-end' }}>
            {[{ day: 'PN', h: '60', f: '85' }, { day: 'WT', h: '90', f: '95' }, { day: 'ŚR', h: '75', f: '100', active: true }, { day: 'CZ', h: '45', f: '60' }, { day: 'PT', h: '85', f: '90' }, { day: 'SB', h: '0', f: '0' }, { day: 'ND', h: '0', f: '0' }].map((col, i) => (
